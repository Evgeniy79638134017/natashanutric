# Наталья Еременко — сайт нутрициолога

Персональный сайт нутрициолога-биохакера Натальи Еременко. Построен на Astro 5 с Tailwind CSS 4, TypeScript, MDX и React.
